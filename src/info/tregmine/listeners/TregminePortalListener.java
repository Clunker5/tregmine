...
//	World mainWorldEnd = Bukkit.getWorld("world_the_end");
	...
	//
	// // Simply add another line changing frame, under, world and name to add a
	// new portal! (Similar to end portal)
	// }
	//
	// public void handlePortal(TregminePlayer player, Material underType,
	// Material frame, World newWorld, String worldName, Block in, Block under)
	// {
	...
	// }
	//
	// public boolean frameCheck(TregminePlayer p, int x1, int x2, int z1, int
	// z2, Material portal)
	// {
