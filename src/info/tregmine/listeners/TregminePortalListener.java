...
//			Bukkit.getPluginManager().callEvent(new TregminePortalEvent(player.getWorld(), Bukkit.getWorld("world"), player));
...
//        } else {
//			Bukkit.getPluginManager().callEvent(new TregminePortalEvent(player.getWorld(), newWorld, player));
