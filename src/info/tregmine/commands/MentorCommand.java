...
public class MentorCommand extends AbstractCommand
{
    ...
    public boolean handlePlayer(TregminePlayer player, String[] args)
    {
        ...
        if ("queue".equalsIgnoreCase(action)) {
            ...
            if (player.getStudent() != null) {
                player.sendStringMessage(RED + "You can only mentor one " +
            ...
            player.sendStringMessage(GREEN + "You are now part of the mentor queue. " +
            ...
            if (player.getRank() == Rank.TOURIST) {
                ...
                mentor.sendStringMessage(player.getName() + "" + RED + " cancelled " +
                        "mentoring with you.");
                player.sendStringMessage(GREEN + "Mentoring cancelled. Attempting to " +
            ...
            player.sendStringMessage(GREEN + "Mentoring of " + student.getName() +
            ...
            Tregmine.LOGGER.info("[MENTOR] " + student.getName() + " was " +
                                 "promoted to settler by " + player.getName() +
                                 ".");
    ...
    public static void findMentor(Tregmine plugin, TregminePlayer student)
    {
        ...
        if (mentor != null) {
            ...
            for (TregminePlayer p : plugin.getOnlinePlayers()) {
                ...
                p.sendStringMessage(student.getName() +
                                      ...
                                      TregminePlayer mentor)
    {
        ...
        Tregmine.LOGGER.info("[MENTOR] " + mentor.getName() + " is " +
                "mentoring " + student.getName());

        // Instructions for students
        student.sendStringMessage(mentor.getName() + GREEN +
        ...
        student.sendStringMessage(YELLOW + "He or she will show you " +
                ...
                "to build.");
        student.sendStringMessage(YELLOW + "If your mentor turns out to be unhelpful, " +
                "type " + RED + "/mentor cancel" + YELLOW + " to stop and wait " +
                "for a new mentor to become available.");

        // Instructions for mentor
        mentor.sendStringMessage(GREEN + "You have been assigned to " +
                "mentor " + student.getName() + GREEN + ".");
        ...
        mentor.sendStringMessage(YELLOW + "4. Help him or her to find a lot " +
        ...
        mentor.sendStringMessage(YELLOW + "Scamming new players will not be  "+
                "tolerated.");
        mentor.sendStringMessage(YELLOW + "Mentoring takes at least 15 minutes, and " +
                ...
                YELLOW + ".");
        mentor.sendStringMessage(YELLOW + "Please start by teleporting to " +
                student.getName() + YELLOW + ", or by summoning him or her!");
    }
}
