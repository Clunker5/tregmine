	...
	public boolean handlePlayer(TregminePlayer player, String[] args){
		...
		if(!success){
			...
			if(!player.getLastPos().toString().isEmpty()){
				player.sendStringMessage(ChatColor.RED + "But... I can give you your coordinates. X" + player.getLastPos().getBlockX() + " Y" + player.getLastPos().getBlockY() + " Z" + player.getLastPos().getBlockZ());
			}
		}
		return true;
	}
