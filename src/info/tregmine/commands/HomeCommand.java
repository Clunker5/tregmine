...
public class HomeCommand extends AbstractCommand
{
    ...
    private boolean teleport(TregminePlayer player, String name)
    {
        ...
        if (loc == null) {
            player.sendStringMessage(RED + "Telogric lift malfunctioned. "
        ...
        if (world.isChunkLoaded(chunk)) {
            ...
            player.sendStringMessage(AQUA + "Hoci poci, little gnome. Magic worked, "
                    + "you're in your home!");
        }
        else {
            player.sendStringMessage(RED
    ...
    private boolean save(TregminePlayer player, String name)
    {
        ...
        try (IContext ctx = tregmine.createContext()) {
            ...
            if (homes.size() > limit) {
                player.sendStringMessage(RED + "You can't have more than " +
                    limit + " homes.");
                return true;
            }
