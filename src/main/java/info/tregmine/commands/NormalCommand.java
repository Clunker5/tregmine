...
public class NormalCommand extends AbstractCommand {
    ...
    public boolean handlePlayer(GenericPlayer player, String[] args) {
        ...
        // player.sendMessage(YELLOW + "You are now donator until you
        // reconnect.");
        // return true;
        ...
        // player.sendMessage(YELLOW + "You are now guardian until you
        // reconnect.");
        // return true;
        // }else{
        // player.sendMessage(ChatColor.RED + "Arguments must be /normal
        // <guardian, donator>");
        // return true;
        // }
        //
        ...
        // tregmine.getServer().getOnlinePlayers();
        ...
        // + "You are now in normal mode, and no longer have to response to help
        // requests.");
        ...
        // else {
        // player.sendMessage(BLUE
        // + "Not enough guardians are on to manage the server. We need you to
        // keep working. Sorry. :/");
        // }
        // }
