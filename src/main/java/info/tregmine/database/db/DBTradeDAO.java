...
public class DBTradeDAO implements ITradeDAO {
    ...
    public int getAmountofTrades(int id) throws DAOException {
        String sql = "SELECT sender_id FROM trade ";
        sql += "WHERE sender_id = ?";
    ...
    public void insertStacks(int tradeId, ItemStack[] contents) throws DAOException {
        String sql = "INSERT INTO trade_item (trade_id, item_material, " + "item_data, item_meta, item_count) ";
        sql += "VALUES (?, ?, ?, ?, ?)";
    ...
    public int insertTrade(int srcId, int recvId, int amount) throws DAOException {
        String sql = "INSERT INTO trade (sender_id, recipient_id, " + "trade_timestamp, trade_amount) ";
