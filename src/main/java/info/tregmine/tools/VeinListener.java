...
public class VeinListener implements Listener {
    ...
    public List<Block> anyConnectedBlocks(Block block, List<Block> cBlock) {
        ...
        for (Block b : knownBlocks) {
            ...
            if (one.getType().equals(material) && !cBlock.contains(one))
                cBlock.add(one);
            if (two.getType().equals(material) && !cBlock.contains(two))
                cBlock.add(two);
            if (three.getType().equals(material) && !cBlock.contains(three))
                cBlock.add(three);
            if (four.getType().equals(material) && !cBlock.contains(four))
                cBlock.add(four);
            if (five.getType().equals(material) && !cBlock.contains(five))
                cBlock.add(five);
            if (six.getType().equals(material) && !cBlock.contains(six))
                cBlock.add(six);
            if (seven.getType().equals(material) && !cBlock.contains(seven))
                cBlock.add(seven);
            if (eight.getType().equals(material) && !cBlock.contains(eight))
                cBlock.add(eight);
            if (nine.getType().equals(material) && !cBlock.contains(nine))
                cBlock.add(nine);
            if (ten.getType().equals(material) && !cBlock.contains(ten))
                cBlock.add(ten);
        }
    ...
    public void VeinMiner(BlockBreakEvent event) {
        ...
        if (!block.getType().equals(Material.GOLD_ORE) && !block.getType().equals(Material.DIAMOND_ORE)
                && !block.getType().equals(Material.IRON_ORE) && !block.getType().equals(Material.REDSTONE_ORE)
        ...
        for (Block b : connectedBlocks) {
            ...
            if (enchantments.containsKey(Enchantment.SILK_TOUCH)) {
                ...
                if (b.getType().equals(Material.DIAMOND_ORE))
                    item = new ItemStack(Material.DIAMOND_ORE, 1, b.getData());
                if (b.getType().equals(Material.IRON_ORE))
                    item = new ItemStack(Material.IRON_ORE, 1, b.getData());
                if (b.getType().equals(Material.GOLD_ORE))
                    item = new ItemStack(Material.GOLD_ORE, 1, b.getData());
                if (b.getType().equals(Material.EMERALD_ORE))
                    item = new ItemStack(Material.EMERALD_ORE, 1, b.getData());
                if (b.getType().equals(Material.COAL_ORE))
                    item = new ItemStack(Material.COAL_ORE, 1, b.getData());
                if (b.getType().equals(Material.LAPIS_ORE))
                    item = new ItemStack(Material.LAPIS_ORE, 1, b.getData());
                if (b.getType().equals(Material.REDSTONE_ORE))
                    item = new ItemStack(Material.REDSTONE_ORE, 1, b.getData());
                ...
                if (b.getType().equals(Material.DIAMOND_ORE))
                    item = new ItemStack(Material.DIAMOND, (1 * multiplyer), b.getData());
                if (b.getType().equals(Material.IRON_ORE))
                    item = new ItemStack(Material.IRON_ORE, (1 * multiplyer), b.getData());
                if (b.getType().equals(Material.GOLD_ORE))
                    item = new ItemStack(Material.GOLD_ORE, (1 * multiplyer), b.getData());
                if (b.getType().equals(Material.EMERALD_ORE))
                    item = new ItemStack(Material.EMERALD, (1 * multiplyer), b.getData());
                if (b.getType().equals(Material.COAL_ORE))
                    item = new ItemStack(Material.COAL, (1 * multiplyer), b.getData());
                if (b.getType().equals(Material.LAPIS_ORE))
                    item = new ItemStack(Material.INK_SACK, (fortuneRandomiser(4, 8) * multiplyer), (byte) 4);
                if (b.getType().equals(Material.REDSTONE_ORE))
                    item = new ItemStack(Material.REDSTONE, (fortuneRandomiser(4, 5) * multiplyer), b.getData());

            } else {

                if (b.getType().equals(Material.DIAMOND_ORE))
                    item = new ItemStack(Material.DIAMOND, 1, b.getData());
                if (b.getType().equals(Material.IRON_ORE))
                    item = new ItemStack(Material.IRON_ORE, 1, b.getData());
                if (b.getType().equals(Material.GOLD_ORE))
                    item = new ItemStack(Material.GOLD_ORE, 1, b.getData());
                if (b.getType().equals(Material.EMERALD_ORE))
                    item = new ItemStack(Material.EMERALD, 1, b.getData());
                if (b.getType().equals(Material.COAL_ORE))
                    item = new ItemStack(Material.COAL, 1, b.getData());
                if (b.getType().equals(Material.LAPIS_ORE))
                    item = new ItemStack(Material.INK_SACK, fortuneRandomiser(4, 8), (byte) 4);
                if (b.getType().equals(Material.REDSTONE_ORE))
                    item = new ItemStack(Material.REDSTONE, fortuneRandomiser(4, 5), b.getData());
