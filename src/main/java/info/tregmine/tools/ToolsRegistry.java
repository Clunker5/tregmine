...
public class ToolsRegistry {
    ...
    public final static Set<Material> LumberAxeAllowed = EnumSet.of(Material.WOOD_AXE, Material.STONE_AXE,
    ...
    public final static Set<Material> VeinMinerAllowed = EnumSet.of(Material.WOOD_PICKAXE, Material.STONE_PICKAXE,
    ...
    public final static Set<Material> GravityGunAllowed = EnumSet.of(Material.DIAMOND_HOE);
    ...
    /**
     * Creates and returns an ItemStack for the token which will create an
     * GravityGun tool
     *
     * @return ItemStack
     */
    ...
    /**
     * Creates and returns an ItemStack for the token which will create a
     * Lumberaxe
     *
     * @return ItemStack
     */
