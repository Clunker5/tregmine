...
--
-- Host: localhost
-- Generation Time: Mar 28, 2017 at 01:09 AM
...
CREATE TABLE `fishyblock` (
  ...
  `fishyblock_material` varchar(24) DEFAULT NULL,
...
CREATE TABLE `inventory_changelog` (
  ...
  `changelog_material` varchar(24) DEFAULT NULL,
...
CREATE TABLE `inventory_item` (
  ...
  `item_material` varchar(24) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `player` (
  ...
  `player_wallet` bigint(20) DEFAULT '15000',
...
CREATE TABLE `playerinventory_item` (
  ...
  `item_material` varchar(24) DEFAULT NULL,
  `item_data` int(11) DEFAULT NULL,
  `item_meta` text,
...
CREATE TABLE `player_givelog` (
  ...
  `givelog_material` varchar(24) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `player_orelog` (
  ...
  `player_id` int(10) UNSIGNED DEFAULT NULL,
  `orelog_material` varchar(24) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `player_referlog`
--

CREATE TABLE `player_referlog` (
  `inviter_id` int(12) NOT NULL,
  `invitee_id` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
